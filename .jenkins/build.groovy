node {
    ...
    stage('Run tests') {
        ...
        sh 'dotnet test ./src/ScriptCompiler.Tests/ScriptCompiler.Tests.csproj -c Release --no-restore --logger \"junit;LogFilePath=\'$WORKSPACE\'/TestResults/1.0.0.\'$BUILD_NUMBER\'/results.xml\"'
    }
